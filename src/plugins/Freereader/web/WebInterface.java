...
public class WebInterface 
{
	...
	public void load()
	{
		...
		toadletContainer.register(mainToadlet = new MainPageToadlet(client, freereader), "Freereader", "/freereader/", true, "Common.Status", "Common.Status", true, null);
		toadletContainer.register(feedsToadlet = new FeedsPageToadlet(client, freereader), "Freereader", "/freereader/feeds", true, "Common.AddRemoveFeeds", "Common.AddRemoveFeeds", true, null);
		toadletContainer.register(configToadlet = new ConfigPageToadlet(client, freereader), "Freereader", "/freereader/config", true, "Common.Configuration", "Common.Configuration", true, null);
	}
